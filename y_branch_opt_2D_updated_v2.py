...
initial_points_x1 = np.linspace(0.8e-6,1.0e-6,initial_x1_size)
initial_points_y1 = np.linspace(0.0,0.1e-6,initial_points_x1.size)
def splitter(params):
    ...
    points_y1 = np.concatenate(([initial_points_y1.min()], params[initial_points_x.size:], [initial_points_y1.max() + 0.01e-6]))
    ...
    polygon_points = np.array(polygon_points_up1 + polygon_points_up[::-1] + polygon_points_down + polygon_points_down1[::-1])
